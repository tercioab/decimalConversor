...
test('submits form and displays result in Hexacecimal', () => {
  render(<Page />);
...
test('submits form and displays result in Binarie', () => {
  render(<Page />);
...
test('submits form and displays result in Octal', () => {
  render(<Page />);
...
test('submits form and displays result Hexadecimal on list', () => {
  render(<Page />);
...
test('submits form and displays result Binário on list', () => {
  render(<Page />);
